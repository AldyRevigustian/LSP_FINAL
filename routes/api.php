...
Route::group(['middleware' => ['auth:sanctum', 'role:admin'], 'prefix' => 'admin'], function () {
        ...
        Route::prefix('berita')->controller(App\Http\Controllers\API\admin\BeritaController::class)->group(function () {
                Route::get('/', 'index');
                Route::post('/', 'store');
                Route::post('/{id}', 'update');
                Route::delete('/{id}', 'destroy');
...
Route::group(['middleware' => ['auth:sanctum', 'role:user'], 'prefix' => 'user'], function () {
        ...
        Route::prefix('berita')->controller(App\Http\Controllers\API\user\BeritaController::class)->group(function () {
                Route::get('/', 'index');
        });
